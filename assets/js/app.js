...
window.onload = () => {
  ...
  Array.from(document.querySelectorAll(".add-form-field"))
	...
	let insertedRow = container.insertAdjacentHTML("beforeend",       newRow.replace(/__name__/g, index));
	container.dataset.index = parseInt(container.dataset.index) + 1;
	container.lastElementChild.querySelector("a.remove-form-field").onclick = (e) => {
